        ...
        <main className="flex flex-col gap-24 sm:gap-32 items-center pb-24 w-[90%] max-w-7xl mx-auto overflow-hidden">
            ...
            >
                ...
                <div className="order-1 lg:order-2 relative group">
                    ...
                    <img
                        ...
                        alt="Market Hero"
                        className="relative rounded-2xl shadow-2xl border border-white/10 object-cover w-full h-[400px] transition-transform duration-500 group-hover:scale-[1.02]"
                    />
                </div>
            </motion.section>
            ...
            >
                ...
                <div className="relative w-full h-[50vh] sm:h-[80vh] rounded-3xl overflow-hidden border-8 border-white dark:border-[#1E2024] shadow-2xl">
                    <iframe
                        className="w-full h-hull grayscale hover:grayscale-0 transition-all duration-700"
